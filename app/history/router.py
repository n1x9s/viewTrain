...
from app.history.schemas import InterviewHistoryList, InterviewHistoryDetail, InterviewHistoryItem
...
async def get_interview_history(
    ...
    interviews = await InterviewHistoryDAO.get_user_interview_history(session, current_user.id)
...
async def get_interview_detail(
    ...
    interview = await InterviewHistoryDAO.get_user_interview_detail(session, current_user.id, interview_id)
